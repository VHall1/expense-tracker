...
const (
	SnowflakeService_GenerateID_FullMethodName = "/SnowflakeService/GenerateID"
)
...
type SnowflakeServiceClient interface {
	GenerateID(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GenerateIDResponse, error)
}
...
func (c *snowflakeServiceClient) GenerateID(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GenerateIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateIDResponse)
	err := c.cc.Invoke(ctx, SnowflakeService_GenerateID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SnowflakeServiceServer interface {
	GenerateID(context.Context, *emptypb.Empty) (*GenerateIDResponse, error)
...
func (UnimplementedSnowflakeServiceServer) GenerateID(context.Context, *emptypb.Empty) (*GenerateIDResponse, error) {
...
func _SnowflakeService_GenerateID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SnowflakeService_GenerateID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SnowflakeServiceServer).GenerateID(ctx, req.(*emptypb.Empty))
	}
